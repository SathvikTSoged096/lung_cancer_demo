...
def generate_patient_report(patient_name, result_label, score):
    ...
    c.drawCentredString(width / 2, height - 2*cm, "Lung Cancer Detection Report")
    ...
    c.drawString(2*cm, y, f"Diagnosis Result: {result_label}")
    y -= 1*cm
    ...
    c.drawString(
        2*cm,
        y,
        "Disclaimer: This report is generated by an AI prototype and is not a medical diagnosis."
    )
    ...
    if patient_name.strip() == "":
        ...
        with open(pdf_path, "rb") as f:
            st.download_button(
                ...
                data=f,
                file_name=f"{patient_name}_lung_cancer_report.pdf",
